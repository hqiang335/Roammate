...
- Web-Rooter via the project wrapper + Quark for cited public web evidence and real-experience signals: hotel areas/tier fit, restaurant reputation, scenic route tactics, queue/crowd warnings, family fit, and avoidance. Promote to `官方确认` only when the cited page is official.
